...
import { useBerasPolos } from '../../lib/beras_polos';
...
const Kas = () => {
    const { data, error } = useBerasPolos()
    ...
    async function hapusTransaksi(id) {
        ...
        let res = await fetch(`/api/beras_polos/hapus?id=${id}`, { method: 'DELETE' })
        let json = await res.json()
        if (!res.ok) throw Error(json.message)
        mutate('/api/beras_polos/hapus')
        alert('Transaksi telah dihapus')
        Router.push('/beras_polos/beras_polos')
        ...
        <>
            ...
            <div className='mt-2'>
                <div className="jumbotron text-center" style={{ backgroundColor: '#25316D' }}>
                    <h3 className="display-12" style={{ color: 'orange' }}><em>Stok Beras Polos</em></h3>
                </div>
            </div>
...
function TransactionModal() {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch("http://localhost:3000/api/beras_polos/input", {
                method: 'POST',
                headers: {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Transaksi Beras Polos</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
function KasUpdate(props) {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch('/api/beras_polos/update', {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
