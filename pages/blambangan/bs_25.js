...
const Kas = () => {
    ...
    async function hapusTransaksi(id) {
        ...
        let res = await fetch(`/api/bs_25/hapus?id=${id}`, { method: 'DELETE' })
        let json = await res.json()
        if (!res.ok) throw Error(json.message)
        mutate('/api/bs_25/hapus')
        alert('Transaksi telah dihapus')
        Router.push('/blambangan/bs_25')
    ...
    return (
        <>
            <Head>
                <title>Stok Blambangan Sakti 25Kg</title>
            ...
            <div className='mt-2'>
                <div className="jumbotron text-center" style={{ backgroundColor: '#25316D' }}>
                    <h3 className="display-12" style={{ color: 'orange' }}><em>Stok Blambangan Sakti 25Kg</em></h3>
                </div>
            </div>
...
function TransactionModal() {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch("http://localhost:3000/api/bs_25/input", {
                method: 'POST',
                headers: {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Transaksi Blambangan Sakti 25Kg</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
function KasUpdate(props) {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch('/api/bs_25/update', {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
