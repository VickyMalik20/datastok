...
import { useBroken } from '../../lib/broken';
...
const Kas = () => {
    ...
    async function hapusTransaksi(id) {
        ...
        let res = await fetch(`/api/broken/hapus?id=${id}`, { method: 'DELETE' })
        let json = await res.json()
        if (!res.ok) throw Error(json.message)
        mutate('/api/broken/hapus')
        alert('Transaksi telah dihapus')
        Router.push('/broken/broken')
        ...
        <>
            ...
            <div className='mt-2'>
                <div className="jumbotron text-center" style={{ backgroundColor: '#25316D' }}>
                    <h3 className="display-12" style={{ color: 'orange' }}><em>Stok Broken</em></h3>
                </div>
            </div>
...
function TransactionModal() {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch("http://localhost:3000/api/broken/input", {
                method: 'POST',
                headers: {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Transaksi Broken</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
function KasUpdate(props) {
    ...
    async function submitHandler(e) {
        ...
        try {
            const res = await fetch('/api/broken/update', {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
