        ...
        <>
            ...
            <div className='mt-2'>
                <div className="jumbotron text-center" style={{ backgroundColor: '#25316D' }}>
                    <h3 className="display-12" style={{ color: 'orange' }}><em>Stok SG Selatan</em></h3>
                </div>
            </div>
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Transaksi SG Selatan</Modal.Title>
                </Modal.Header>
                <Modal.Body>
